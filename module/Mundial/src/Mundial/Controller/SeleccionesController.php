...
class SeleccionesController extends AbstractActionController
{
    public function indexAction()
    {
        ...
        $urlNotas = $urlJson. '/noticias/' . $seccion . '/noticias-principales.txt';
        ...
        $compartir = array('titulo'=>'Seccion Selecciones del mundo', 'url'=> $_SERVER['REQUEST_URI']);
