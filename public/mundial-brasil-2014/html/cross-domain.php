...
$valid_requests = array(
     'www.eltiempo.com','e.eltiempo.com','eltiempo.com'
);
...
if ( preg_match( '!' . $_SERVER['SCRIPT_NAME'] . '!', $request_url ) || empty( $request_url ) || count( $p_request_url ) == 1 ) {
    csajax_debug_message( 'Invalid request - make sure that csurl variable is not empty SN '.$_SERVER['SCRIPT_NAME'] .' ('. $request_url .')  ('.count( $p_request_url ).')' );
    //exit;
    return;
}
